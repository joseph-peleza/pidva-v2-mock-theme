        ...
        <Row>
          <Col lg={12} md={12} sm={12} xs={24}>
            ...
            <div className="ant-row-flex">
              ...
              <Avatar className="gx-mr-2" size="large" icon="user" src="https://wieldy.g-axon.work/assets/images/avatar/a8.png"/>
            ...
            <br/>
            <Progress  style={{ marginLeft: "50px" }} type="circle" percent={78}/>
