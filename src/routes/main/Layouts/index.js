...
const Layouts = ({navStyle, onNavStyleChange}) => {
  return <Row className="gx-layouts-view">
    ...
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        ...
        <img src={'src/assets/images/layouts/default-no-header.png'} alt='vertical no header'/>
        </span>
    </Col>
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        ...
        <img src={'src/assets/images/layouts/dark-menu.png'} alt='default horizontal'/>
        </span>
    </Col>
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        <span onClick={() => onNavStyleChange(NAV_STYLE_DARK_HORIZONTAL)}
              className={`gx-pointer ${navStyle === NAV_STYLE_DARK_HORIZONTAL && 'active'}`}>
        <img src={'src/assets/images/layouts/detail-menu.png'} alt='dark horizontal'/>
        </span>
    </Col>
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        ...
        <img src={'src/assets/images/layouts/menu-with-header.png'} alt='inside header horizontal'/>
        </span>
    </Col>
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        <span onClick={() => onNavStyleChange(NAV_STYLE_BELOW_HEADER)}
              className={`gx-pointer ${navStyle === NAV_STYLE_BELOW_HEADER && 'active'}`}>
        <img src={'src/assets/images/layouts/bottom-menu.png'} alt='below header'/>
        </span>
    </Col>
    ...
    <Col xl={6} lg={8} md={12} sm={12} xs={12}>
        ...
        <img src={'src/assets/images/layouts/top-menu.png'} alt='top to header'/>
        </span>
    </Col>
  </Row>
};
